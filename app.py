...
def run_task1():
    def run_all_scripts():
        ...
        scripts = [
            # each tuple: (absolute script path, working directory)
            (os.path.join(BASE_DIR, "Whiteface", "Whiteface_precip_type.py"),
             os.path.join(BASE_DIR, "Whiteface")),
            (os.path.join(BASE_DIR, "Whiteface", "Whiteface_Snow_rate.PY"),
             os.path.join(BASE_DIR, "Whiteface")),
            (os.path.join(BASE_DIR, "Whiteface", "Whiteface.py"),
             os.path.join(BASE_DIR, "Whiteface")),
        ]
